library(ggplot2)
dir = getwd()
setwd(paste(dir, '/', 'FB123_F1', sep = ''))
obs1 = read.csv('/Users/kylecoleman/data/walsh/all/clustering2/annotations_completed_cortical_dist/FB123_R2-2/A-PFC_obs_cp.csv')
obs2 = read.csv('/Users/kylecoleman/data/walsh/all/clustering2/annotations_completed_cortical_dist/FB123_R2-2/B-Cing_obs_cp.csv')
obs = rbind(obs1, obs2)
