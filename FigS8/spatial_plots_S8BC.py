...
#adata1 = sc.read('/Users/kylecoleman/data/walsh/all/clustering2/merscope_855_no_counts.h5ad')
...
def make_plot(sample, region, h1_type):
    ...
    plt.tight_layout();
    plt.savefig(dict1[sample + '-' + region].replace('-', '_') + '_' + h1_type + '.png', dpi=800); plt.savefig(dict1[sample + '-' + region].replace('-', '_') + '_' + h1_type + '.pdf'); plt.clf()
